...
const CreatePlan = () => {
  ...
  useEffect(() => {
    const fetchPlan = async () => {
      ...
      try {
        ...
        console.error("Fetch plan error:", err.response?.data || err.message);
      }
    };
  ...
  const savePlan = async () => {
    ...
    try {
      ...
      console.error("Save plan error:", err.response?.data || err.message);
      alert(err.response?.data?.msg || "Error saving plan");
